...
export const Category = () => {
    ...
    const loadData = async() => {
        ...
        try{
            let catResp = await http.get(`https://online-job-portal-0ksn.onrender.com/category/${params.id}`)
            setCategory(catResp.data)
            let proResp = await http.get(`https://online-job-portal-0ksn.onrender.com/category/${params.id}/jobs`)
